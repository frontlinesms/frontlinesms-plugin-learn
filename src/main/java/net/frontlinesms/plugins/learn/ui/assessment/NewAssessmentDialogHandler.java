...
public class NewAssessmentDialogHandler extends EditAssessmentDialogHandler {
	public NewAssessmentDialogHandler(FrontlineUI ui, AssessmentDao assessmentDao, AssessmentMessageDao assessmentMessageDao, GroupDao groupDao, TopicDao topicDao, TopicItemDao topicItemDao) {
		super(ui, assessmentDao, assessmentMessageDao, groupDao, topicDao, topicItemDao, new Assessment());
