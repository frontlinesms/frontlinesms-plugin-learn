...
public class AssessmentMessageJobTest extends ApplicationContextAwareTestCase {
	/** instance under test */
	private AssessmentMessageJob job;
	...
	public void testExecute() throws JobExecutionException {
		...
		// then
		verify(frontlineController).sendTextMessage("+12345", "Got milk? Reply: 16TRUE or 16FALSE");
